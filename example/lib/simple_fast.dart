...
import 'package:malison_flutter/src/fast/fast_retro_terminal.dart';
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            FastRetroTerminal(controller: terminalController),
          ],
        ),
      ),
    );
...
class SimpleScreen extends FlutterScreen<String> {
  ...
  void update() {
    // Rendering looks correct when this is commented out.
    dirty();
  }
